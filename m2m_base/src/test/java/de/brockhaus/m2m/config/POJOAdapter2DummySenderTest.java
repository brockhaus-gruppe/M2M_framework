 ...
 *
 */
public class POJOAdapter2DummySenderTest {

	private static String configFile = "test/POJOADAPTER2DUMMY_STACKCONFIG.xml";
	...
	public static void main(String[] args) throws M2MCommunicationException {
		POJOAdapter2DummySenderTest test = new POJOAdapter2DummySenderTest();
		test.init();
...
//		 test.sendForever(1000);
	...
	private static void init() {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(POJOAdapter2DummySenderTest.configFile);
