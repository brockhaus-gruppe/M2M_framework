...
/**
 * Test whether the communication through http works fine ...
 * Maybe it's a good idea to have a servlet ready.
 * 
 * Project: m2m-base
 *
...
public class POJOAdapter2HTTPTest {
	...
	public static void main(String[] args) throws M2MCommunicationException {
		POJOAdapter2HTTPTest test = new POJOAdapter2HTTPTest();
		test.init();

		test.sendByNumbers(300, 1000);
