 ...
 *
 */
public class POJOAdapter2CassandraTest {
	...
	public static void main(String[] args) throws M2MCommunicationException {
		POJOAdapter2CassandraTest test = new POJOAdapter2CassandraTest();
		test.init();

		test.sendByNumbers(300, 10);
	...
	private void init() {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext(
				"POJOADAPTER2CASSANDRA_STACKCONFIG.xml");
	...
	private void sendForever(int interval) throws M2MCommunicationException {
		...
		M2MSensorMessage msg = new M2MSensorMessage();
		msg.setDatatype(M2MDataType.FLOAT);
		msg.setSensorId("PT_DS1_316233.ED01_AB219_M04.AS.V2251");
